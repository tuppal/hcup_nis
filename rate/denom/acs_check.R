...
nat_check_11<-data.frame("Characteristics"=check_var, "n"=check_val)
...
fl_check_11<-data.frame("Characteristics"=fl_check_var, "n"=fl_check_val)

ut_check_var<-c("Weighted", "65-75", "75+", "Female", "Male")
ut_check_val<-c(1936143, 143300, 115024, 971816, 964327)
ut_check_11<-data.frame("Characteristics"=ut_check_var, "n"=ut_check_val)
}else if(year==2014){
#acs_check
...
check_var<-c("Weighted", "65-75", "75+", "Female", "Male")
check_val<-c(245279633, 26418204, 19796689, 126005451, 119274182)
acs_check_14<-data.frame("Characteristics"=check_var, "n"=check_val)
...
ne_check_14<-data.frame("Characteristics"=ne_check_var, "n"=ne_check_val)

md_check_var<-c("Weighted", "65-75", "75+", "Female", "Male")
md_check_val<-c(4625232, 479017, 343154, 2419617, 2205615)
md_check_14<-data.frame("Characteristics"=md_check_var, "n"=md_check_val)
...
nc_check_16<-data.frame("Characteristics"=nc_check_var, "n"=nc_check_val)

ny_check_var<-c("Weighted", "65-75", "75+", "Female", "Male")
ny_check_val<-c(15565903, 1715037, 1315744, 8119421, 7446482)
ny_check_16<-data.frame("Characteristics"=ny_check_var, "n"=ny_check_val)
...
nj_check_17<-data.frame("Characteristics"=nj_check_var, "n"=nj_check_val)

az_check_var<-c("Weighted", "65-75", "75+", "Female", "Male")
az_check_val<-c(5383542, 701165, 499685, 2728146, 2655396)
az_check_17<-data.frame("Characteristics"=az_check_var, "n"=az_check_val)
}else(print("next"))
